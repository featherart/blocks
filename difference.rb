...
# One difference is in the way they handle arguments. 
# Creating a proc using proc {} and Proc.new {} are equivalent. 
...
# In addition, using return inside a lambda returns the value of that lambda, 
...
# strict argument checking (which can also sometimes help with debugging), 
# or if you need to use the return statement to return the value of the proc, use lambda.